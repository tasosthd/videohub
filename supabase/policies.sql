...
-- Storage bucket setup. Run after creating buckets named: videos, thumbnails, avatars.
-- Recommended: mark all 3 buckets as public because this app serves public video URLs.
